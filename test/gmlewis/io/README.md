...
<div id="mod-info">
    <h1 id="mod-title"> io <span id="mod-version">v0.19.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-io">https://github.com/gmlewis/moonbit-io</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/io </code></pre>
    <div id="build-error"> 
