...
<div id="mod-info">
    <h1 id="mod-title"> base64 <span id="mod-version">v0.13.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-base64">https://github.com/gmlewis/moonbit-base64</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/base64 </code></pre>
    <div id="build-error"> 
