...
<div id="mod-info">
    <h1 id="mod-title"> image <span id="mod-version">v0.14.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-image">https://github.com/gmlewis/moonbit-image</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/image </code></pre>
    <div id="build-error"> 
