...
<div id="mod-info">
    <h1 id="mod-title"> crc32 <span id="mod-version">v0.8.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-crc32">https://github.com/gmlewis/moonbit-crc32</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/crc32 </code></pre>
    <div id="build-error"> 
