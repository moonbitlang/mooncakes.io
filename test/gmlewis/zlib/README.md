...
<div id="mod-info">
    <h1 id="mod-title"> zlib <span id="mod-version">v0.18.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-zlib">https://github.com/gmlewis/moonbit-zlib</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/zlib </code></pre>
    <div id="build-error"> 
