...
<div id="mod-info">
    <h1 id="mod-title"> fonts-b <span id="mod-version">v0.15.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/mbt-fonts-b">https://github.com/gmlewis/mbt-fonts-b</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/fonts-b </code></pre>
    <div id="build-error"> 
...
# gmlewis/mbt-fonts-b
[![check](https://github.com/gmlewis/mbt-fonts-b/actions/workflows/check.yml/badge.svg)](https://github.com/gmlewis/mbt-fonts-b/actions/workflows/check.yml)
