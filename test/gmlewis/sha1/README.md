...
<div id="mod-info">
    <h1 id="mod-title"> sha1 <span id="mod-version">v0.9.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-sha1">https://github.com/gmlewis/moonbit-sha1</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/sha1 </code></pre>
    <div id="build-error"> 
