...
<div id="mod-info">
    <h1 id="mod-title"> gzip <span id="mod-version">v0.31.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-gzip">https://github.com/gmlewis/moonbit-gzip</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/gzip </code></pre>
    <div id="build-error"> 
