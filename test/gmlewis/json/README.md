...
<div id="mod-info">
    <h1 id="mod-title"> json <span id="mod-version">v0.15.0</span></h1>
    simple json parser
    <hr/>
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-libs/json">https://github.com/gmlewis/moonbit-libs/json</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/json </code></pre>
    <div id="build-error"> 
