...
<div id="mod-info">
    <h1 id="mod-title"> moonbit-pdk <span id="mod-version">v0.46.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-pdk">https://github.com/gmlewis/moonbit-pdk</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/moonbit-pdk </code></pre>
    <div id="build-error"> 
