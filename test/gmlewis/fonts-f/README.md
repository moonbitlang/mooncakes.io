...
<div id="mod-info">
    <h1 id="mod-title"> fonts-f <span id="mod-version">v0.15.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/mbt-fonts-f">https://github.com/gmlewis/mbt-fonts-f</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/fonts-f </code></pre>
    <div id="build-error"> 
...
# gmlewis/mbt-fonts-f
[![check](https://github.com/gmlewis/mbt-fonts-f/actions/workflows/check.yml/badge.svg)](https://github.com/gmlewis/mbt-fonts-f/actions/workflows/check.yml)
