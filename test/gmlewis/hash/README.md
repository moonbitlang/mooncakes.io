...
<div id="mod-info">
    <h1 id="mod-title"> hash <span id="mod-version">v0.17.0</span></h1>
    MoonBit hash: provide hash functions similar to Go.
    <hr/>
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-hash">https://github.com/gmlewis/moonbit-hash</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/hash </code></pre>
    <div id="build-error"> 
