...
<div id="mod-info">
    <h1 id="mod-title"> memory <span id="mod-version">v0.8.4</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/peter-jerry-ye/memory">https://github.com/peter-jerry-ye/memory</a></p>
        </div>
    </div>
    <hr/>
    <div id="mod-install-info">
        ...
        <pre><code> moon add peter-jerry-ye/memory </code></pre>
    <div id="build-error"> 
