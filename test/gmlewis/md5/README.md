...
<div id="mod-info">
    <h1 id="mod-title"> md5 <span id="mod-version">v0.17.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-md5">https://github.com/gmlewis/moonbit-md5</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/md5 </code></pre>
    <div id="build-error"> 
