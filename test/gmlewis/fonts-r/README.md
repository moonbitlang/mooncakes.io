...
<div id="mod-info">
    <h1 id="mod-title"> fonts-r <span id="mod-version">v0.15.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/mbt-fonts-r">https://github.com/gmlewis/mbt-fonts-r</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/fonts-r </code></pre>
    <div id="build-error"> 
...
# gmlewis/mbt-fonts-r
[![check](https://github.com/gmlewis/mbt-fonts-r/actions/workflows/check.yml/badge.svg)](https://github.com/gmlewis/mbt-fonts-r/actions/workflows/check.yml)
