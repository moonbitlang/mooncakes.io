...
<div id="mod-info">
    <h1 id="mod-title"> fonts-t <span id="mod-version">v0.15.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/mbt-fonts-t">https://github.com/gmlewis/mbt-fonts-t</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/fonts-t </code></pre>
    <div id="build-error"> 
...
# gmlewis/mbt-fonts-t
[![check](https://github.com/gmlewis/mbt-fonts-t/actions/workflows/check.yml/badge.svg)](https://github.com/gmlewis/mbt-fonts-t/actions/workflows/check.yml)
