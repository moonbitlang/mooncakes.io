...
<div id="mod-info">
    <h1 id="mod-title"> fonts-n <span id="mod-version">v0.15.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/mbt-fonts-n">https://github.com/gmlewis/mbt-fonts-n</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/fonts-n </code></pre>
    <div id="build-error"> 
