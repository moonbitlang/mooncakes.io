...
<div id="mod-info">
    <h1 id="mod-title"> sha256 <span id="mod-version">v0.15.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-sha256">https://github.com/gmlewis/moonbit-sha256</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/sha256 </code></pre>
    <div id="build-error"> 
