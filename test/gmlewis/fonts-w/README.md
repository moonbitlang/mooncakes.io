...
<div id="mod-info">
    <h1 id="mod-title"> fonts-w <span id="mod-version">v0.15.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/mbt-fonts-w">https://github.com/gmlewis/mbt-fonts-w</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/fonts-w </code></pre>
    <div id="build-error"> 
...
# gmlewis/mbt-fonts-w
[![check](https://github.com/gmlewis/mbt-fonts-w/actions/workflows/check.yml/badge.svg)](https://github.com/gmlewis/mbt-fonts-w/actions/workflows/check.yml)
