...
- ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/header.mbt,3:::impl <a href="moonbitlang/core/builtin#Eq">Eq</a> for <a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a> with op_equal(<a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>, <a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>) -> Bool
  ```
  > automatically derived
- ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/header.mbt,3:::impl <a href="moonbitlang/core/builtin#Show">Show</a> for <a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a> with output(<a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>, <a href="moonbitlang/core/builtin#Logger">Logger</a>) -> Unit
  ```
  > automatically derived
- ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/header.mbt,3:::impl <a href="moonbitlang/core/builtin#ToJson">ToJson</a> for <a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a> with to_json(<a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>) -> <a href="moonbitlang/core/json#Json">Json</a>
  ```
  > automatically derived
...
- #### op\_equal
  ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/header.mbt,3:::fn <a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>::op_equal(<a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>, <a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>) -> Bool
  ```
  > automatically derived
- #### output
  ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/header.mbt,3:::fn <a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>::output(<a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>, <a href="moonbitlang/core/builtin#Logger">Logger</a>) -> Unit
  ```
  > automatically derived
- #### set
  ```moonbit
...
- #### to\_json
  ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/header.mbt,3:::fn <a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>::to_json(<a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>) -> <a href="moonbitlang/core/json#Json">Json</a>
  ```
  > automatically derived
- #### to\_string
  ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/traits.mbt,85:::fn <a href="gmlewis/moonbit-pdk/pdk/http#Header">Header</a>::to_string[Self : <a href="moonbitlang/core/builtin#Show">Show</a>](self : Self) -> String
  ```
  > 
...
#### mooncakes-io-implementation-mark-Implementations
- ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/method.mbt,22:::impl <a href="moonbitlang/core/builtin#Show">Show</a> for <a href="gmlewis/moonbit-pdk/pdk/http#Method">Method</a> with output(<a href="gmlewis/moonbit-pdk/pdk/http#Method">Method</a>, <a href="moonbitlang/core/builtin#Logger">Logger</a>) -> Unit
  ```
  > automatically derived
...
- #### output
  ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/method.mbt,22:::fn <a href="gmlewis/moonbit-pdk/pdk/http#Method">Method</a>::output(<a href="gmlewis/moonbit-pdk/pdk/http#Method">Method</a>, <a href="moonbitlang/core/builtin#Logger">Logger</a>) -> Unit
  ```
  > automatically derived
- #### to\_json
  ```moonbit
...
- #### to\_string
  ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/traits.mbt,85:::fn <a href="gmlewis/moonbit-pdk/pdk/http#Method">Method</a>::to_string[Self : <a href="moonbitlang/core/builtin#Show">Show</a>](self : Self) -> String
  ```
  > 
...
#### mooncakes-io-implementation-mark-Implementations
- ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/http.mbt,6:::impl <a href="moonbitlang/core/builtin#ToJson">ToJson</a> for <a href="gmlewis/moonbit-pdk/pdk/http#Request">Request</a> with to_json(<a href="gmlewis/moonbit-pdk/pdk/http#Request">Request</a>) -> <a href="moonbitlang/core/json#Json">Json</a>
  ```
  > automatically derived
...
- #### to\_json
  ```moonbit
  :::source,gmlewis/moonbit-pdk/pdk/http/http.mbt,6:::fn <a href="gmlewis/moonbit-pdk/pdk/http#Request">Request</a>::to_json(<a href="gmlewis/moonbit-pdk/pdk/http#Request">Request</a>) -> <a href="moonbitlang/core/json#Json">Json</a>
  ```
  > automatically derived
