...
<div id="mod-info">
    <h1 id="mod-title"> b2 <span id="mod-version">v0.31.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/moonbit-b2">https://github.com/gmlewis/moonbit-b2</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/b2 </code></pre>
    <div id="build-error"> 
