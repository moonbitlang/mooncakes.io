...
<div id="mod-info">
    <h1 id="mod-title"> fonts-l <span id="mod-version">v0.15.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/mbt-fonts-l">https://github.com/gmlewis/mbt-fonts-l</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/fonts-l </code></pre>
    <div id="build-error"> 
...
# gmlewis/mbt-fonts-l
[![check](https://github.com/gmlewis/mbt-fonts-l/actions/workflows/check.yml/badge.svg)](https://github.com/gmlewis/mbt-fonts-l/actions/workflows/check.yml)
