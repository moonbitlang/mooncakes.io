...
<div id="mod-info">
    <h1 id="mod-title"> fonts-s <span id="mod-version">v0.15.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/mbt-fonts-s">https://github.com/gmlewis/mbt-fonts-s</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/fonts-s </code></pre>
    <div id="build-error"> 
...
# gmlewis/mbt-fonts-s
[![check](https://github.com/gmlewis/mbt-fonts-s/actions/workflows/check.yml/badge.svg)](https://github.com/gmlewis/mbt-fonts-s/actions/workflows/check.yml)
