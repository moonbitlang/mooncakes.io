...
<div id="mod-info">
    <h1 id="mod-title"> fonts-m <span id="mod-version">v0.15.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/mbt-fonts-m">https://github.com/gmlewis/mbt-fonts-m</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/fonts-m </code></pre>
    <div id="build-error"> 
...
# gmlewis/mbt-fonts-m
[![check](https://github.com/gmlewis/mbt-fonts-m/actions/workflows/check.yml/badge.svg)](https://github.com/gmlewis/mbt-fonts-m/actions/workflows/check.yml)
