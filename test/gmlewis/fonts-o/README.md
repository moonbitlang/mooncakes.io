...
<div id="mod-info">
    <h1 id="mod-title"> fonts-o <span id="mod-version">v0.15.0</span></h1>
    ...
    <div id="mod-meta-data">
        ...
        <div>
            <p>Repository</p>
            <p><a href="https://github.com/gmlewis/mbt-fonts-o">https://github.com/gmlewis/mbt-fonts-o</a></p>
        </div>
        <div>
            <p>Keywords</p>
            <ul id="mod-keywords">
    ...
    <div id="mod-install-info">
        ...
        <pre><code> moon add gmlewis/fonts-o </code></pre>
    <div id="build-error"> 
...
# gmlewis/mbt-fonts-o
[![check](https://github.com/gmlewis/mbt-fonts-o/actions/workflows/check.yml/badge.svg)](https://github.com/gmlewis/mbt-fonts-o/actions/workflows/check.yml)
